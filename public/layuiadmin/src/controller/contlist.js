...
layui.define(['table', 'form'], function(exports){
  ...
  //   ,url: 'http://localhost/layui/lay.php?c=account/getServiceUserList' //模拟接口
  //   ,cols: [[
  ...
  table.render({
    elem: '#LAY-app-content-list'
    // ,url: './json/content/list.js' //模拟接口
    ,url: 'http://localhost/layui/lay.php?c=living/livingInfoList' //模拟接口
    ,where: {
      access_token: layui.data('layuiAdmin').access_token
    }
    ,cols: [[
      // {type: 'checkbox', fixed: 'left'}
      ,{field: 'living_id', width: 100, title: 'ID', sort: true}
      ,{field: 'name', title: '姓名', minWidth: 100}
      ,{field: 'phone', title: '电话'}
      ,{field: 'title', title: '直播间标题'}
      ,{field: 'is_secret', title: '是否加密', sort: true}
      ,{field: 'up_time', title: '提交时间'}
      ,{title: '操作', minWidth: 150, align: 'center', fixed: 'right', toolbar: '#table-content-list'}
    ]]
    ,page: true
    ,limit: 5
    ...
    if(obj.event === 'del'){
      ...
      admin.popup({
        ...
        ,success: function(layero, index){
          ...
          view(this.id).render('app/listform', data).done(function(){
